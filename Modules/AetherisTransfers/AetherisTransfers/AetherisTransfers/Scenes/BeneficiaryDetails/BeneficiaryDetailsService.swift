    ...
    static func transactions(for name: String) -> [BeneficiaryTransactionModel] {
        [
            BeneficiaryTransactionModel(
                ...
                description: Strings.BeneficiaryDetails.thanksForCollaboration,
                amount: 75,
                currencyCode: "USD",
                date: Date(),
                status: .completed
            ...
            BeneficiaryTransactionModel(
                ...
                description: Strings.BeneficiaryDetails.dinnerWith(name),
                amount: 50,
                currencyCode: "USD",
            ...
            BeneficiaryTransactionModel(
                ...
                kind: .sent,
                title: Strings.BeneficiaryDetails.transferSent,
                description: Strings.BeneficiaryDetails.concertTicket,
                amount: 200,
                currencyCode: "USD",
